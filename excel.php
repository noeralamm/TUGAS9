<?php  
session_start(); //session mulai diekskusi
include('konek.php'); //memanggil file koneksi.php
...
echo "Ekspor Berhasil Silahkan Lihat Data di (C:xampp=>htdocs=>reportexcel)";
?>